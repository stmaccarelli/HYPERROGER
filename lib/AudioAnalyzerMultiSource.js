function AAMS(audioFileData, params){
  ...
  analyserNode.smoothingTimeConstant = params.smoothing!==undefined?params.smoothing:0.5;
  ...
  //  if( (selectedSource==FILE && !audioFile.paused) || selectedSource==GUM )
  ...
  t.getFreq = function(n){
    var value = isMobile?128:dataArray[n];
    if(selectedSource==FILE)
      return value/256;
    else return value/200;
