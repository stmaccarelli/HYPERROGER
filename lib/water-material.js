...
THREE.ShaderLib['water'] = {
  ...
  fragmentShader: [
    ...
    '  vec2 uv0 = uv / (103.0 * noiseScale) - vec2(time / 17.0, time / 19.0);',
    '  vec2 uv1 = uv / (107.0 * noiseScale) - vec2(time / -19.0, time / 11.0);',
...
THREE.Water = function (renderer, camera, scene, options) {
  ...
  this.noiseScale = optionalParameter(options.noiseScale, 1.5);
