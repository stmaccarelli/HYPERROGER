...
'float refSampleLuma = (reflectionSample.r+reflectionSample.g+reflectionSample.b) / 3.0;',
   ' gl_FragColor = vec4( color * scatter * 5.0 + mirrorFinal*0.5 + mirrorFinal*color*0.5  + specularLight*mirrorFinal*(reflectionSample*reflectionSample)*1.8, 0.9-length(scatter)*0.7 );',//' , alpha + (reflectance*(1.0-alpha)) );',//alpha );',
...
THREE.Water = function (renderer, camera, scene, options) {
  ...
  this.alpha = optionalParameter(options.opacity, 0.86);
