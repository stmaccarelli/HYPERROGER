...
THREE.ShaderLib['water'] = {
  ...
  fragmentShader: [
    ...
    ' vec3 outgoingLight = mix((waterColor + reflectance * waterColor)*0.5  + reflectance*sunColor*diffuseLight, reflectionSample * waterReflectivity + reflectionSample * specularLight, reflectance );',
//interessante    ' gl_FragColor = vec4( vec3(reflectance), alpha * reflectance);',//alpha );',
    ' gl_FragColor = vec4( albedo, alpha + (reflectance*(1.0-alpha)) );',//alpha );',
