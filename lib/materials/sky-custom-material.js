THREE.SkyShaderMaterial = function(options) {
    ...
    //  #ifdef TEXTURED
      ...
      vec4 texelColor =
				...
				texelColor = clamp( texelColor, 0.0, 1.0);
			//
			// texelColor = mix(texelColor, texelColor2, mixFactor*mixFactor*mixFactor*mixFactor*mixFactor);
			//
      //  texelColor = mapTexelToLinear( texelColor );
      //    #endif

      gl_FragColor = vec4(color.rgb * texelColor.rgb , 1.0);
		}
      `
	};
