...
var LightNoise = function () {

  var floorX, floorY, floorZ, X, Y, Z,
  	xMinus1, yMinus1, zMinus1,
    u, v, w,
    A, AA, AB, B, BA, BB,
    h,gu,gv;
	...
	return {
		...
		noise: function (x, y, z) {
			...
			floorX = Math.floor(x); floorY = Math.floor(y); floorZ = Math.floor(z);
			...
			xMinus1 = x -1; yMinus1 = y - 1; zMinus1 = z - 1;
