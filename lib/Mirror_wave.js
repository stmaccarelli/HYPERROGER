...
THREE.ShaderLib[ 'mirror' ] = {
	...
	vertexShader: [
		...
		"float posY = 2.0 + sin( time * -15.0 + nPos.x * nPos.z * 200.0) * 1.01;",
    ...
    THREE.ShaderChunk[ "fog_pars_fragment" ],
		"void main() {",
			...
			"color = vec4( mix(mirrorColor,color.rgb,0.5), opacity);",
			"gl_FragColor = color;",
...
THREE.Mirror = function ( renderer, camera, options ) {
	...
	var _opacity = options.opacity !== undefined ? options.opacity : 1.0;
