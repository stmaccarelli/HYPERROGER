...
THREE.ShaderLib['water_hy'] = {
  ...
  fragmentShader: [
    ...
    '  vec2 uv0 = uv / (2103.0 * noiseScale) - vec2(advance / 17.0, advance / 29.0) + vec2(0.0,advance*0.01);',
    '  vec2 uv1 = uv / (2107.0 * noiseScale) - vec2(advance / -19.0, advance / 31.0) + vec2(0.0,advance*0.01);',
    '  vec2 uv2 = uv / (2111.0 * noiseScale) - vec2(advance / 11.0, advance /  57.0) + vec2(0.0,advance*0.01);',
    '  vec2 uv3 = uv / (2115.0 * noiseScale) - vec2(advance / 19.0, advance / -23.0) + vec2(0.0,advance*0.01);',
    '  vec4 noise = ',
