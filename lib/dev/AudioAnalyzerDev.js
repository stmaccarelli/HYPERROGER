...
var AudioAnalyzer = function( sourceFile, tempFreqArray, numFreqs) {

window.AudioContext = window.AudioContext || window.webkitAudioContext;
sourceFile = sourceFile || null;
var analyzerFreqs = 256; //512;
...
function createAudioMeter(clipLevel,averaging,clipLag) {
	...
	processor.averaging = 0;//averaging || 0.18;
	processor.clipLag = 5000;//clipLag || 750;
  processor.updating = 240;
